...
@router.get("/search/name/{name}", response_model = Page[ServiceRead])
async def search_services_by_name(request: Request,
    ...
    """
    return await apaginate(db_session, ServiceService.search_services_by_name(name))

@router.get("/search/name/", response_model = Page[ServiceRead])
...
@router.get("/search/price_range/{min_price}/{max_price}", response_model = Page[ServiceRead])
async def search_services_by_price_range(request: Request,
    ...
    """
    return await apaginate(db_session, ServiceService.search_services_by_price_range(min_price, max_price))

@router.get("/search/price_range/", response_model = Page[ServiceRead])
...
@router.get("/search/cost_range/{min_cost}/{max_cost}", response_model = Page[ServiceRead])
async def search_services_by_cost_range(request: Request,
    ...
    """
    return await apaginate(db_session, ServiceService.search_services_by_cost_range(min_cost, max_cost))

@router.get("/search/cost_range/", response_model = Page[ServiceRead])
...
@router.get("/service_input/product/{product_id}", response_model = Page[ServiceInput])
async def search_service_inputs_by_product(request: Request,
                                         product_id: int,
                                         db_session: AsyncSession = Depends(get_session)):
    """
    Retrieve input services by product ID.
    """
    return await apaginate(db_session, await ServiceService.search_service_inputs_by_product(db_session, product_id))

@router.get("/service_input/product/", response_model = Page[ServiceInput])
async def search_service_inputs_by_product_2(request: Request,
                                           product_id: int,
                                           db_session: AsyncSession = Depends(get_session)):
    """
    Retrieve input services by product ID.
...
@router.get("/service_input/service/{service_id}", response_model = Page[ServiceInput])
async def search_service_inputs_by_service(request: Request,
                                         service_id: int,
                                         db_session: AsyncSession = Depends(get_session)):
    """
    Retrieve input services by service ID.
    """
    return await apaginate(db_session, await ServiceService.search_service_inputs_by_service(db_session, service_id))

@router.get("/service_input/service/", response_model = Page[ServiceInput])
async def search_service_inputs_by_service_2(request: Request,
                                           service_id: int,
                                           db_session: AsyncSession = Depends(get_session)):
    """
    Retrieve input services by service ID.
