...
from models import ServiceBase, Service, Product
...
class ServiceCrud:
    ...
    @classmethod
    async def delete_service(cls, service_id: int) -> None:
    ...
    @classmethod
    async def get_services_input_by_service(cls, service_id: int) -> list[Product]:
